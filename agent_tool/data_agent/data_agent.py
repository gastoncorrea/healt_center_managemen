...
data_agent = Agent(
    ...
    instruction="""
    Eres un agente que recibe la informacion de la tabla y campos necesario para interactuar con la base de datos.
    ...
    #Paso a seguir:
    1. Recibes la consulta del agente especializado con los valores necesarios "accion", "nombre de la tabla" y "valores de los campos necesarios" para la consulta.
